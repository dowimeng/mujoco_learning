...
def qpos_from_site_pose(model, data,
  ...
  Args:
    ...
    # 关节运动的二次惩罚系数
    regularization_strength: (optional) A (7,) numpy array，
      Coefficient of the quadratic penalty on joint movements.
...
def nullspace_method(jac_joints, delta, regularization_strength=0.0):
  ...
  """
    ...
    # if regularization_strength > 0:
        # L2 regularization
    # print(np.eye(hess_approx.shape[0]).dot(regularization_strength))
    if regularization_strength.any() != 0:
        # print("1")
